...
for /f %%b in ('powershell -command "[math]::Round(%MaxFreq1% * 0.35)"') do set LowFreq1=%%b
for /f %%b in ('powershell -command "[math]::Round(%MaxFreq4% * 0.80)"') do set LowFreq4=%%b
...
adb shell settings put global battery_saver_device_specific_constants cpufreq-i=0:%LowFreq7%/1:%LowFreq7%/2:%LowFreq1%/3:%LowFreq1%,cpufreq-n=4:%LowFreq1%/5:%LowFreq1%/6:%LowFreq1%/7:%LowFreq1%
echo.
